...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(text, reply_markup=InlineKeyboardMarkup(keyboard))async def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data.startswith("buy_"):
        ...
        keyboard = [[InlineKeyboardButton("Cancel", callback_data="settings")]]
        await query.edit_message_text(f"Enter Target Price:\nCurrent: {settings['target_value']}", reply_markup=InlineKeyboardMarkup(keyboard))
